...
*/
   ...
   GPIOPinWrite(GPIOA0_BASE, 0x80, 0);//set CS low
   GPIOPinWrite(GPIOA1_BASE, 0x1, 0);//set DC low
   MAP_SPITransfer(GSPI_BASE,&buffer,0,1, SPI_CS_ENABLE|SPI_CS_DISABLE);
   GPIOPinWrite(GPIOA0_BASE, 0x80, 0x80);//set CS high
...
*/
    ...
    GPIOPinWrite(GPIOA0_BASE, 0x80, 0); //set CS low.
    GPIOPinWrite(GPIOA1_BASE, 0x1, 0x1);  //set DC high
    MAP_SPITransfer(GSPI_BASE,&buffer,0,1, SPI_CS_ENABLE|SPI_CS_DISABLE);
    GPIOPinWrite(GPIOA0_BASE, 0x80, 0x80);//set CS high
